...
class CoutureTemplatesMixin:  # pylint: disable=too-few-public-methods
    ...
    list_columns = ["dashboard_link", "creator", "published", ]
    order_columns = ["dashboard_link", "published"]
    edit_columns = [
        "dashboard_title",
        "slug",
        "owners",
    ...
    def pre_delete(self, item: "CoutureTemplatesMixin") -> None:  # pylint: disable=no-self-use
        check_ownership(item)
